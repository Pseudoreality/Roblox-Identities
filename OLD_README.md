...
Wrapping it up, you can view a script's identity by calling the `printidentity()` function, however for checking a script's capabilities, you can either refer to what is listed further down or you can run [the Lua script provided in this repository](https://github.com/Pseudoreality/Roblox-Identities/blob/main/CheckCapabilities.lua).
...
* RobloxSecurity
  ...
  - Notes: This member is intended for strictly internal usage only.
    ...
    - The official Roblox docs say CoreScripts can use this[^robloxSecurityReference], but they're lying because I haven't been able to get CoreScripts to access these members.
      - Here's an image of me trying to call `Player.GetGameSessionID()` from a CoreScript: ![](https://i.imgur.com/XzXnHhK.png)
...
* COM (Component Object Model?)
  ...
  - Notes: Used by RCCService when running gameserver.txt
    - Also used by Roblox script executors, like Synapse (rip LOL), to completely ignore all identity-related errors.
      - On a related note, some free exploits use ElevatedStudioPlugin for some dumbass reason.
    - It can create a Player instance so I'm happy enough. ![](https://i.imgur.com/H9n6npM.png)
* WebService
  - Number: 8
  - Capabilities: All
  ...
  - Notes **(speculation)**: Something to do with `LuaWebService`, RCCService, or both
    ...
    - Ditto! ![](https://i.imgur.com/FVEBDEq.png)
* Replicator
  - Number: 9
  - Capabilities:
  ...
  - Notes **(speculation)**: Most likely something to do with Replication Jobs
    - Tritto! ![](https://i.imgur.com/ghKHDAT.png)
* Invalid Identity
