...
- If this is attempted, it will error with `The current thread cannot extend 'Capabilities' (lacking permission x)`, with `x` being the first capability in the attempted list that the current thread doesn't have.
